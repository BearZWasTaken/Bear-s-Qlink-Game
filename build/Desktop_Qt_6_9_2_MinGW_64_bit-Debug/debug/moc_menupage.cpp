...
void MenuPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MenuPage::*)()>(_a, &MenuPage::NewGame, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (MenuPage::*)()>(_a, &MenuPage::LoadGame, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (MenuPage::*)()>(_a, &MenuPage::ExitGame, 2))
            return;
    }
}
...
// SIGNAL 0
void MenuPage::NewGame()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MenuPage::LoadGame()
{
