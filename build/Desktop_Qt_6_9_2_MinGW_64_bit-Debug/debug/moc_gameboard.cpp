...
template <> constexpr inline auto GameBoard::qt_create_metaobjectdata<qt_meta_tag_ZN9GameBoardE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'LinkSuccess'
        QtMocHelpers::SignalData<void(const std::vector<Coord> &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Signal 'GameOver'
...
void GameBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->LinkSuccess((*reinterpret_cast< std::add_pointer_t<std::vector<Coord>>>(_a[1]))); break;
        case 1: _t->GameOver((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameBoard::*)(const std::vector<Coord> & )>(_a, &GameBoard::LinkSuccess, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameBoard::*)(bool , QString )>(_a, &GameBoard::GameOver, 1))
            return;
    }
}
...
// SIGNAL 0
void GameBoard::LinkSuccess(const std::vector<Coord> & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void GameBoard::GameOver(bool _t1, QString _t2)
{
